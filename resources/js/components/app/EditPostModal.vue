                    ...
                    <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
                        ...
                        <DialogPanel
                            ...
                            <div class="mb-4 flex items-center justify-between border-b border-gray-200 pb-4">
                                ...
                                <button type="button"
                                    class="rounded-full p-1 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                    @click="closeModal">
                            ...
                            <form @submit.prevent="handleSubmit">
                                <div class="mb-4">
                                    ...
                                    <textarea id="post-body" v-model="form.body" rows="5"
                                        class="w-full resize-none rounded-lg border border-gray-300 px-4 py-3 text-gray-900 placeholder-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                        placeholder="What's on your mind?" @input="autoResize" />
                                ...
                                <div class="flex justify-end gap-3">
                                    ...
                                    <button type="submit" :disabled="form.processing || !form.body"
                                        class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                                        {{
                                            form.processing
                                                ? 'Updating...'
                                                : 'Update Post'
