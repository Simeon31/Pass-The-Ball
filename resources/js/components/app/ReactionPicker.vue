...
<template>
    <Popover class="relative">
        <PopoverButton
            class="flex flex-1 cursor-pointer items-center justify-center gap-1 rounded-lg bg-gray-100 px-4 py-2 text-gray-800 transition-all hover:bg-gray-200 focus:outline-none"
            ...
            <span v-if="currentReaction && currentReactionData">{{ currentReactionData.label }}</span>
